...
export default {
  ...
  async asyncData({ $axios, params }) {
    try {
      const item = await $axios.$get(`classes/classworkes/${params.lesson_id}/`)
      const comments = await $axios.$get(
        `comments/classwork-class/${params.lesson_id}/`
      )
    ...
    async createComment() {
      try {
        await this.$axios.$post('comments/classwork-comment/', {
          ...
          classwork: this.$route.params.lesson_id,
        })
        this.comments = await this.$axios.$get(
          `comments/classwork-class/${this.$route.params.lesson_id}/`
        )
        this.comment = ''
      } catch (err) {
